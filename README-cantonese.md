...
- **零依賴環境**：唔需要手動安裝 Python 。第一次執行時會**自動下載同更新**最新嘅 ` yt-dlp . exe ` 同 ` ffmpeg . exe ` ［ cite ：1］。
...
- 提供1080p 、720p 限制選項［ cite ：1］。 
- 支援高音質純音樂提取（ MP3320k/M4A ）同完整播放清單打包［ cite ：1］。
- **進階功能**：
